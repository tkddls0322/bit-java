...
public class StringEx {
	...
	private static void stringMethods() {
		...
		System.out.println("m의 위치 인덱스 2nd:"+s.indexOf("m",12));	// 12번 인덱스부터 검색을 해달라는 의미
		//	검색 시작 위치를 12번 인덱스부터
		...
		System.out.println("모두치환 : "+ s.replaceAll("Fun", "Funny").replace('?', '!'));

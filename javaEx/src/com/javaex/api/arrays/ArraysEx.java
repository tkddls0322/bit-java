...
public class ArraysEx {
	...
	private static void customSearch() {
		System.out.println("----- 사용자 정의 자료형의 검색 -----");
		Member[] members = {
				new Member("홍길동"),
				new Member("고길동"),
				new Member("임꺽정"),
		...
		int index = Arrays.binarySearch(members,
							new Member("장길산")); // 사용자 정의 객체의 검색시에는 객체를 넘겨주어
												 // 해당 객체와 같은지를 비교해줘야 한다
	...
	private static void basicSearch() {
		...
		System.out.println("Linux Index:"+index2);
	}
	...
	private static void basicSortDescendingTest() {
		System.out.println("----- Basic Sort DES -----");
	...
	private static void basicSortTest() {
		System.out.println("----- Basic Sort ASC -----");

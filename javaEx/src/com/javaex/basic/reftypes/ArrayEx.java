...
public class ArrayEx {
	...
	public static void arrayCopySystem() {
		System.out.println("----- Copy System -----");
		int scores[] = {90,80,70};
	...
	public static void arrayNDim() {
		System.out.println("----- Array N Dimen -----");
		// 2차원 배열로 연습
		int[][] twoDim = new int[3][5]; // 3행 5열 배열
	...
	public static void arrayMemoryTest() {
		...
		System.out.println("----- Array Memory Test -----");
		int scores[] = {
				80,90,100,70
		};
